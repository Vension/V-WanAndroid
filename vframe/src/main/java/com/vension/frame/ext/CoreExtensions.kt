...
fun Activity.showSnackMsg(msg: String) {
    ...
    view.findViewById<TextView>(R.id.snackbar_text).setTextColor(ContextCompat.getColor(this,
        R.color.color_white
    ))
    snackbar.show()
}
...
fun Fragment.showSnackMsg(msg: String) {
    ...
    val view = snackbar.view
    view.findViewById<TextView>(R.id.snackbar_text).setTextColor(ContextCompat.getColor(this.activity!!,
        R.color.color_white
    ))
    snackbar.show()
}
