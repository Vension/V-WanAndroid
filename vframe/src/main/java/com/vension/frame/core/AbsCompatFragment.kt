...
abstract class AbsCompatFragment : Fragment(), IFragment,View.OnClickListener {
     ...
     */
    protected var fraMultiStatusLayout: MultiStatusLayout? = null
    /**
     ...
     * 缓存上一次的网络状态
     */
    protected var hasNetwork: Boolean by PreferenceUtil(Constant.KEY_HAS_NETWORK, true)
