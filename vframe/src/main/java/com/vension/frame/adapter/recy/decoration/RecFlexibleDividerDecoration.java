package com.vension.frame.adapter.recy.decoration;
 ...
 */
public abstract class RecFlexibleDividerDecoration extends RecyclerView.ItemDecoration {
	...
	protected RecFlexibleDividerDecoration(Builder builder) {
