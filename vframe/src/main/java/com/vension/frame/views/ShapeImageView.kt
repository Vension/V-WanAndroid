...
class ShapeImageView(context: Context, attrs: AttributeSet) : AppCompatImageView(context, attrs) {
    ...
    init {
        ...
        mType = ta.getInt(R.styleable.ShapeImageView_siv_type, DEFAULT_TYPE)
        mBorderColor = ta.getColor(R.styleable.ShapeImageView_siv_borderColor, DEFAULT_BORDER_COLOR)
        mBorderWidth = ta.getDimensionPixelSize(R.styleable.ShapeImageView_siv_borderWidth, dp2px(DEFAULT_BORDER_WIDTH))
        mRectRoundRadius = ta.getDimensionPixelSize(R.styleable.ShapeImageView_siv_rectRoundRadius, dp2px(
