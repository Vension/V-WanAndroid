...
class ExpandableTextView : LinearLayout, View.OnClickListener {
    ...
    private fun initView(attrs: AttributeSet) {
        ...
        mMaxCollapsedLines = typedArray.getInt(R.styleable.ExpandableTextView_exTv_maxCollapsedLines, MAX_COLLAPSED_LINES)
        mAnimationDuration = typedArray.getInt(R.styleable.ExpandableTextView_exTv_animDuration, DEFAULT_ANIM_DURATION)
        mAnimAlphaStart = typedArray.getFloat(R.styleable.ExpandableTextView_exTv_animAlphaStart, DEFAULT_ANIM_ALPHA_START)
        mExpandDrawable = typedArray.getDrawable(R.styleable.ExpandableTextView_exTv_expandDrawable)
        mCollapseDrawable = typedArray.getDrawable(R.styleable.ExpandableTextView_exTv_collapseDrawable)
