...
public class CircleMusicView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            mProgressWidth = ta.getDimensionPixelOffset(R.styleable.CircleMusicView_circle_music_view_progress_width,
                    defaultBorderWidth);
            mProgressSlotColor = ta.getColor(R.styleable.CircleMusicView_circle_music_view_progress_slot_color,
                    Color.LTGRAY);
            mProgressBufferColor= ta.getColor(R.styleable.CircleMusicView_circle_music_view_progress_buffer_color,
                    Color.GRAY);
    ...
    public void setProgressSlotColor(@ColorRes int color) {
        this.mProgressSlotColor = color;
        invalidate();
    }
