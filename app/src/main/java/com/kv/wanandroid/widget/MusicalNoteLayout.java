package com.kv.wanandroid.widget;
...
import com.kv.wanandroid.widget.util.DPPXUtil;
import com.kv.wanandroid.widget.util.WeakWrapperHandler;
...
public class MusicalNoteLayout extends RelativeLayout implements WeakWrapperHandler.MessageHandler {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mMusicView.setProgressSlotColor(R.color.colorAppTheme);
        ...
        Drawable note1 = getResources().getDrawable(R.drawable.icon_music_note1);
        Drawable note2 = getResources().getDrawable(R.drawable.icon_music_note2);
        Drawable note3 = getResources().getDrawable(R.drawable.icon_music_note3);
        mDrawables = new ArrayList<>();
        for (int i = 0; i < 3; i++) {
            if (i == 0){
                mDrawables.add(note1);
            }else if(i == 1){
                mDrawables.add(note2);
            }else if(i == 2){
                mDrawables.add(note3);
            }else{
                mDrawables.add(note1);
            }
        }
